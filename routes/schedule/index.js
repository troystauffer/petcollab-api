class ScheduleRoutes {
  constructor(router, args) {
    ...
    router.get('/events/:event_id/schedules', schedule.isAuthorized(['any']), schedule.list);
    router.get('/schedules/:schedule_id', schedule.isAuthorized(['any']), schedule.detail);
