...
let Crud = {
  delete: function({classname, db, req, res}) {
    ...
    if (req.validationErrors()) return res.status(400).json({ success: false, message: 'The data provided to the API was invalid or incomplete.', errors: req.validationErrors() });
